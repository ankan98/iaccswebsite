...
export default function MembershipStatusFormClient({ initialPageData }) {
  ...
  useEffect(() => {
    ...
    fetch(`${apiBase}/get_page.php?slug=membership-status`)
      ...
      .catch((e) => console.error("Client fetch membership-status page data error:", e));
  }, []);
    ...
    <div className="bg-white">
      ...
      <section className="w-full bg-white flex flex-col gap-10 py-16 xl:px-[110px] md:px-20 px-5 mt-[40px]">
        <div>
          ...
          >
            {pageData?.title || "Application Status Check"}
          </h1>
          {pageData?.heading && (
          ...
          <p className="text-gray-700 max-w-3xl">
            {pageData?.subheading || "Enter your Membership ID / Reference ID and Date of Birth to check your status."}
          </p>
          {pageData?.content && (

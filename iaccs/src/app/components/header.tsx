...
export default function Header() {
   ...
   <nav className="flex z-[9] items-center justify-between w-full px-[110px] py-[18px] fixed top-0 left-0 bg-white border-b border-[#00000066] backdrop-blur-[15px] backdrop-brightness-[100%]">
        <Link className="flex items-center w-[129px] h-11" href="/">
            <div className="font-bold text-[#000000] text-3xl tracking-[0] leading-[44px] whitespace-nowrap">
                ACCS
            </div>
        </Link>

        <nav className="flex items-center justify-center gap-10 px-5 py-4">
            <Link className="font-medium text-base tracking-[0] leading-[normal] whitespace-nowrap text-[#525560]" href="/">Home</Link>
            ...
            <Link className="font-medium text-base tracking-[0] leading-[normal] whitespace-nowrap text-secondary-text" href="/membership">Membership</Link>
        ...
        <button className="h-auto px-8 py-3 bg-gray-800 rounded hover:bg-opacity-90">
            <Link className="font-medium text-white text-base text-right tracking-[0] leading-[normal] whitespace-nowrap" href="/membership"> Donate Now </Link>
        </button>
    </nav>
    );
  }
      ...
      <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="container mx-auto xl:px-[110px] md:px-20 px-5 relative z-[1]">
            <div className="w-full max-w-[642px] flex flex-col gap-12">
                <h1 className="w-full max-w-[640px] font-bold text-white xl:text-[64px] md:text-4xl text-3xl tracking-[0] xl:leading-[76.8px]">Contact Us</h1>
                <p className="text-lg text-white">Have any questions or want to work with us? Feel free to reach out anytime.</p>
            </div>
        </div>
    </header>

    <section className="w-full flex flex-col gap-16 py-16 xl:px-[110px] md:px-20 px-5">
              ...
              <div className="space-y-8">
                ...
                <div className="">
                  ...
                  <div className="space-y-4 text-gray-700">
                    ...
                    <p>
                      <strong>Official Email Adress:</strong>  
                      - <a href="mailto:admin@iaccs.org.in">admin@iaccs.org.in</a>
                    </p>
                  </div>
                </div>

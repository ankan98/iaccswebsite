            ...
            <div className="flex-1 flex flex-col gap-8 relative text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    <div className="bg-white p-6 rounded-xl text-center">
                        ...
                        />
                        <h3 className="text-xl font-semibold uppercase mt-4">Bapan Sarkar</h3>
                    ...
                    <div className="bg-white p-6 rounded-xl text-center">
                        ...
                        className="w-48 h-48 mx-auto rounded-xl object-cover border border-gray-200"
                        />
                        <h3 className="text-xl font-semibold uppercase mt-4">Atri Banerjee </h3>
                    ...
                    <div className="bg-white p-6 rounded-xl text-center">
                        ...
                        className="w-48 h-48 mx-auto rounded-xl object-cover border border-gray-200"
                        />
                        <h3 className="text-xl font-semibold uppercase mt-4">Trina Ghorai</h3>
